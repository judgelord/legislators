...
# clean up example data from congressionalrecord package
cr2007_03_01 <- cr2007_03_01 |> 
  dplyr::select(date, speaker, header, url, url_txt) |>
  #filter(!stringr::str_detect(chamber, "Ext")) |>
  dplyr::filter(!stringr::str_detect(speaker, "^NA$"))
